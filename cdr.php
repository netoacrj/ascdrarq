...
$array = array ("INTRODU&Ccedil;&Atilde;O", "RELAT&Oacute;RIO CDR", "COMPARA&Ccedil;&Atilde;O DE CHAMADAS", "TR&Aacute;FEGO MENSAL","CARGA DI&Aacute;RIA","GRAVA&Ccedil;&Atilde;O" ,"VOLTAR");
$s = $s ? $s : 0;
$section="section$s$t";
$racine=$PHP_SELF;
	...
	<body>
		...
		<div id="fedora-header">
			...
			<div id="fedora-header-logo">
				 <table border="0" cellpadding="0" cellspacing="0"><tr><td><img src="images/logo.png"  alt="CDR - IPBX | CallCenter"></td><td>
				 <H1><font color="#37728B">&nbsp;&nbsp;&nbsp;Registros Detalhados de Chamadas</font></H1></td></tr></table>
			</div>
...
<?}elseif ($section=="section5"){?>
         ...
         <?require("gravacao.php");?>


<?}elseif ($section=="section6"){?>
        session_start();
	session_destroy();
        <?header('location:../asternic/index.php');?>
